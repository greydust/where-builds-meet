...
try {
  ...
  const skills = {
    Prefight: { name: "Prefight", castTime: 1, action: [damage(0.5)], modifier: [{ effect: { castTimeModifier: 1 } }], tags: ["DirectDamage"] },
    Starting: { name: "Starting", castTime: 2, action: [damage(0.5), damage(1.5), damage(1.75)], modifier: [{ effect: { castTimeMultiplier: 2 } }], tags: ["DirectDamage"] },
  ...
  const result = calculateRotationBaseline({
    timeline: {
      rotation,
      skills,
      eventDefinitions: { Exhausted: { name: "Exhausted", castTime: 0, action: [] }, BattleEnd: { name: "Battle End", castTime: 0, action: [] } },
      dots: {},
      effectDefinitions: {},
      innerWayConditions: [],
      innerWayRules: [],
