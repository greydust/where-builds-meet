...
Exquisite Scenery T6 adds 50% damage to Charged Light, Charged Heavy, Charged
Light Varied Combo, and Charged Heavy Varied Combo attacks. Every qualifying
combination requires the `Charged` tag; a Light or Heavy Varied Combo without
that tag does not receive the bonus.
